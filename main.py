...
# Build the Model
model = Sequential()
model.add(LSTM(units=58, return_sequences=True, input_shape=(x_train.shape[1], 1)))
model.add(Dropout(0.2))
model.add(LSTM(units=58, return_sequences=True))
model.add(Dropout(0.2))
model.add(LSTM(units=58))
model.add(Dropout(0.2))
model.add(Dense(units=1)) #Prediction of next colsing value
